...
intercept_1=mean(chain_betas1[[1]][[1]][burnin:iterations,1][])
distance_1=mean(chain_betas1[[1]][[1]][burnin:iterations,2])
intercept_2=mean(chain_betas1[[1]][[2]][burnin:iterations,1])
distance_2=mean(chain_betas1[[1]][[2]][burnin:iterations,2])
intercept_3=mean(chain_betas1[[1]][[3]][burnin:iterations,1])
distance_3=mean(chain_betas1[[1]][[3]][burnin:iterations,2])
GC_1=mean(chain_betas1[[1]][[1]][burnin:iterations,3])
GC_2=mean(chain_betas1[[1]][[2]][burnin:iterations,3])
GC_3=mean(chain_betas1[[1]][[3]][burnin:iterations,3])
TES_1=mean(chain_betas1[[1]][[1]][burnin:iterations,4])
TES_2=mean(chain_betas1[[1]][[2]][burnin:iterations,4])
TES_3=mean(chain_betas1[[1]][[3]][burnin:iterations,4])
ACC_1=mean(chain_betas1[[1]][[1]][burnin:iterations,5])
ACC_2=mean(chain_betas1[[1]][[2]][burnin:iterations,5])
ACC_3=mean(chain_betas1[[1]][[3]][burnin:iterations,5])
